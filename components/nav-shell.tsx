...
export function NavShell({ mode = "sidebar" }: NavShellProps) {
  ...
  return (
    <aside 
      className={cn(
        "sticky top-4 hidden h-[calc(100vh-2rem)] flex-col rounded-[2rem] border border-[#D4A574]/15 bg-[#02120e]/85 p-3 shadow-[0_16px_64px_rgba(0,0,0,0.6)] backdrop-blur-2xl transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] lg:flex",
    ...
    >
      ...
      <div className="mt-auto space-y-4">
        <AnimatePresence>
          {!collapsed && (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-[1.5rem] border border-[#D4A574]/20 bg-gradient-to-br from-[#1B4D3E]/30 via-[#02120e]/60 to-transparent p-4 transition-all hover:border-[#D4A574]/40"
            >
        ...
        <div className={cn(
          ...
          collapsed ? "flex-col justify-center py-2" : "justify-between px-2"
        )}>
          ...
          {!collapsed && (
            <div className="rounded-full bg-[#1B4D3E]/20 px-2 py-1 border border-[#D4A574]/10">
